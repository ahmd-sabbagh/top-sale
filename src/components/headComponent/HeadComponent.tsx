  ...
  return (
    <div className="flex items-center justify-between">
      ...
      {href && (
        <Link
          href={href}
          className="border border-main-color rounded px-3 md:px-4 py-[8px] md:py-[11px] text-main flex items-center gap-2 transition hover:!bg-[#B02770] hover:!text-white"
        >
          <span className="text-sm">{t("view all")}</span>
